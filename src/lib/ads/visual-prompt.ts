...
export function buildAdVisualPrompt({
  ...
  // ── REFERENCE MODE: short prompt that PRESERVES the user's image at full opacity ──
  if (hasReference) {
    ...
    const refPrompt = [
      ...
      'Use the provided image as the dominant central subject — keep it sharp, prominent, fully visible at 100% opacity, NOT faded or washed out.',
