...
export type StyleCategory =
  ...
  | 'mixed-fusion'
  | 'era-historical'      // Baroque, Art Deco, Mid-Century...
  | 'pro-design'          // Sesión 3: liquid metal, glassmorphism, anti-design...
  | 'vertical-formats';   // Sesión 3: 9:16 mobile-first formats
