  ...
  return (
    <>
      ...
      <button
        ...
        className="h-8 w-8 rounded-md border border-border bg-surface-2 flex items-center justify-center text-fg-muted hover:text-fg hover:border-gold/40 transition-colors lg:hidden"
      >
