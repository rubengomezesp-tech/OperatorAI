 ...
 *
 * Bottom-right ? icon visible siempre en /(app) routes.
 * Click → modal compacto con:
 *   - Search bar (filters articles)
 *   - Tours list (5 tours)
 *   - Top articles
 *   - Contact support
 *
 * Auto-collapse on outside click + Esc key.
 */
...
export function HelpFab() {
  ...
  // Top 3 articles for default view
      ...
      {open && (
        <div className="absolute bottom-14 right-0 w-[380px] max-w-[90vw] rounded-xl border border-border bg-surface-2 shadow-2xl overflow-hidden mb-2">
          ...
          <div className="px-4 py-3 border-b border-border flex items-center justify-between">
            <div>
              <h3 className="font-display text-[15px]">Help & guides</h3>
              ...
              <div className="space-y-0.5">
                ...
                {searchResults.map((article) => (
                  ...
                  >
                    ...
                    <div className="text-[11.5px] text-fg-muted line-clamp-1">
                      {article.excerpt}
                    </div>
                  </Link>
                ))}
          ...
          <div className="border-t border-border px-4 py-2.5">
            ...
            >
              ...
              <span>Email support · hi@operatoraiapp.com</span>
            </a>
          </div>
        </div>
      )}
